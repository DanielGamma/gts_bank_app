    ...
    return (
        ...
        <div className="mt-10">
            <form onSubmit={registerForm} className="flex flex-col gap-3">
                ...
                <input type="text" {...register("firstName",{required:true,pattern: {value:/^[A-Za-z]+$/ , message: "This input is letters only."},})}  className="bg-transparent border-b-[1px] border-solid border-[#626262] focus:outline-none !important text-white pb-2 text-lg" />
                <label htmlFor="last-name" className="text-white-form text-lg">Last Name</label>
                <input type="text" {...register('secondName',{required:true,pattern: {value:/^[A-Za-z]+$/ , message: "This input is letters only."},})}   className="bg-transparent border-b-[1px] border-solid border-[#626262] focus:outline-none !important text-white pb-2 text-lg" />
                ...
                <input type="password" {...register('confirmPassword',{required:true,validate:(value => value === getValues("password") || "la contraseña tiene que ser la misma coño")})}   className="bg-transparent border-b-[1px] border-solid border-[#626262] focus:outline-none !important text-white pb-2 text-lg"/>
                ...
                <button type="submit" className="bg-gray-dark rounded-xl w-full flex justify-center items-center px-6 py-2 mt-12"><p className="text-base not-italic font-medium text-white text-center">CREATE YOUR ACCOUNT</p></button>
            </form>
        </div>
